...
// Solution 1: confine only Human (not contract) can execute this contract
// Solution 2: reveal-commit, both user and contract need to provide seeds for hash. (so user need to deploy blockchain first)